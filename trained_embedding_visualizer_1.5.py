...
def scatter_plot(x, y, data, hue, n_clusters, palette ,title, xlabel, ylabel):
    ...
    p1 = sns.scatterplot(x=x, y=y, data=data, hue=hue, palette=palette_subset )
    plt.title(title)
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    return p1
...
if __name__ == "__main__":
    ...
    trained_emb_dir = '/home/coldmist/PycharmProjects/Trained-Embedding-Visualizer/data/umls/entity_embedding.npy'
    ...
    entity_to_id_dict_dir = '/home/coldmist/PycharmProjects/Trained-Embedding-Visualizer/data/umls/entities.dict'
